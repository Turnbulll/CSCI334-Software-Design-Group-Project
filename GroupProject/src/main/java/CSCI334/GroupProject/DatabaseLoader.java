...
public class DatabaseLoader implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception{
		...
		//emptyPrescriptions.add(prescriptions[0]);
		
		log.info("Patients are arriving..");
		patients[0] = new Patient("Patient1", "password", "Patient", treatments[0], emptyPrescriptions);
		patients[1] = new Patient("Patient2", "password", "Patient", treatments[1], emptyPrescriptions);
		patients[2] = new Patient("Patient3", "password", "Patient", treatments[2], emptyPrescriptions);
		...
		//patientService.addPrescription(patients[0].getUserId(), prescriptions[0].getPrescriptionId());
		//System.out.println(patients[0].toString());
